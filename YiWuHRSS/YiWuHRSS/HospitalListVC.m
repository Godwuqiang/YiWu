...
@interface HospitalListVC ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate,ServiceBLDelegate>
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"定点医院";
    HIDE_BACK_TITLE;
    [self initData];
    [self setupCoverView];
    [self afn];
...
-(void)loadData{
    [self showLoadingUI];
    [self.serviceBL queryDingDianJiGouWith:self.seachKey andtype:@"1" andpageNo:self.pageNo andpageSize:MAX_PAGE_COUNT andTradeCode:@"30014"];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    DDJGBean *bean = self.dataList[indexPath.row];
    HospitalDetailVC *VC = [self.storyboard instantiateViewControllerWithIdentifier:@"HospitalDetailVC"];
...
- (IBAction)Search:(id)sender {
    ...
    self.pageNo=1;
    [self showLoadingUI];
    [self.serviceBL queryDingDianJiGouWith:self.seachKey andtype:@"1" andpageNo:self.pageNo andpageSize:MAX_PAGE_COUNT andTradeCode:@"30011"];
}
