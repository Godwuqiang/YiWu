...
- (CGFloat)getHeightBySizeOfFont:(CGFloat)size width:(CGFloat)width{
    CGRect frame = [self boundingRectWithSize:CGSizeMake(width, 0) options:NSStringDrawingUsesFontLeading | NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:size]} context:nil];
