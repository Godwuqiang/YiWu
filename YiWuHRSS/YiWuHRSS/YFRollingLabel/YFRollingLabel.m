    ...
    if(_textArray.count == 1){
        ...
        if(rect.size.width > KSelfWith){
            ...
            UILabel *label = [[UILabel alloc] initWithFrame:
                              CGRectMake(0, (KSelfHeight - rect.size.height) / 2, rect.size.width, rect.size.height)];
            // UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake((KSelfWith - rect.size.width) / 2, (KSelfHeight - rect.size.height) / 2, rect.size.width, rect.size.height)];
