...
@interface MsgDetailVC ()<WKNavigationDelegate,WKUIDelegate,WKScriptMessageHandler>
...
- (void)userContentController:(WKUserContentController *)userContentController didReceiveScriptMessage:(WKScriptMessage *)message {
    ...
    if ([message.name isEqualToString:@"shareNews"]) {
        ...
        [self ShareWithImg:img andTitle:title andUrl:url];
    }
...
#pragma mark - 分享函数
-(void)ShareWithImg:(NSString*)img andTitle:(NSString*)title andUrl:(NSString*)url{
    ShareView *sv=[ShareView shareViewWithTitle:@"请选择分享平台" cancel:@"取消分享" cancelBtClcik:^{
        ...
        //微信好友按钮点击事件
        DMLog(@"微信好友分享");
        [self ShareWithPlatformType:UMSocialPlatformType_WechatSession Img:img andTitle:title andUrl:url];
    } WechatTimeLineBtClcik:^{
        //微信朋友圈按钮点击事件
        DMLog(@"微信朋友圈分享");
        [self ShareWithPlatformType:UMSocialPlatformType_WechatTimeLine Img:img andTitle:title andUrl:url];
    }];
...
#pragma mark - 友盟分享
-(void)ShareWithPlatformType:(UMSocialPlatformType)platformType Img:(NSString*)img andTitle:(NSString*)title andUrl:(NSString*)url{
