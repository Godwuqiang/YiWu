...
@interface LxModifyHXTVC ()<LoginHttpBLDelegate,UITextFieldDelegate>{
    BOOL       hasnet;
}
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string
{
    ...
    if (textField==self.Sfzhtf || textField==self.Yhkhtf) {
...
- (IBAction)ModifyBtnClicked:(id)sender {
    ...
    NSString *shbzh     = self.Sfzhtf.text;
    NSString *cardno    = @"";
