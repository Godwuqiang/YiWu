...
//    [cancelBtn setTitle:@"重拍" forState:UIControlStateNormal];
    [cancelBtn setTitle:[CoreArchive strForKey:@"cancelTitle"] forState:UIControlStateNormal];
    cancelBtn.backgroundColor = [UIColor whiteColor];
    [cancelBtn setTitleColor:[UIColor colorWithHex:0xfdb731] forState:UIControlStateNormal];
    cancelBtn.titleLabel.font = [UIFont systemFontOfSize:15];
    cancelBtn.frame = CGRectMake(0, SCREEN_HEIGHT - 45, SCREEN_WIDTH / 2, 45);
    [cancelBtn addTarget:self action:@selector(cancel:) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:cancelBtn];
    
    UIButton *confirmBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [confirmBtn setTitle:@"使用照片" forState:UIControlStateNormal];
    confirmBtn.backgroundColor = [UIColor colorWithHex:0xfdb731];
    [confirmBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    confirmBtn.titleLabel.font = [UIFont systemFontOfSize:15];
    confirmBtn.frame = CGRectMake(SCREEN_WIDTH / 2, SCREEN_HEIGHT - 45, SCREEN_WIDTH / 2, 45);
