...
- (void)initContainerView{
    ...
    UIView *selectViewBac = [[UIView alloc] initWithFrame:CGRectMake(0, self.topView.frame.size.height + 216/2 - 25.5, SCREEN_WIDTH, 51)];
    selectViewBac.backgroundColor = [UIColor colorWithHex:0xfdb731];
    [self.bgView addSubview:selectViewBac];
}
...
//    [pickerView.subviews[2] setBackgroundColor:[UIColor whiteColor]];
    ...
    if (pickerView == yearPicker) {
        rowLabel.text =  [NSString stringWithFormat:@"%@",self.yearArray[row]];
        ...
        if ([self.yearArray[yearRow] integerValue] == minYear) {
            ...
            rowLabel.text = [NSString stringWithFormat:@"%ld",(long)[self.minMonthRemainingArray[selectrow] integerValue]];
            ...
            rowLabel.text = [NSString stringWithFormat:@"%ld",(long)[self.maxMonthRemainingArray[selectrow] integerValue]];
        }else{
        ...
        if ([self.yearArray[yearRow] integerValue] == minYear) {
            if ([self.minMonthRemainingArray[monthRow] integerValue] == minMonth) {
                ...
                rowLabel.text = [NSString stringWithFormat:@"%ld",(long)[self.minDayRemainingArray[selectrow] integerValue] ];
            }else{
            ...
            if ([self.maxMonthRemainingArray[monthRow] integerValue] == maxMonth) {
                ...
                rowLabel.text = [NSString stringWithFormat:@"%ld",(long)[self.maxDayRemainingArray[selectrow] integerValue] ];
            }else{
...
//        [yearPicker selectRow:[dateComponent year]-[dateComponentTwo year] inComponent:0 animated:NO];
    ...
    [self.bgView setFrame:CGRectMake(0, kPICKVIEW_SCREEN_HEIGHT - 216 - CGRectGetHeight(self.topView.frame), kPICKVIEW_SCREEN_WIDTH, 216 + self.topView.frame.size.height)];
    ...
    self.bgView.center = CGPointMake(kPICKVIEW_SCREEN_WIDTH / 2, kPICKVIEW_SCREEN_HEIGHT + height / 2);
