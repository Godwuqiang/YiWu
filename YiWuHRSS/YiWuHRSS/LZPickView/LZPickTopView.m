...
#define BG_COLOR [UIColor colorWithRed:255  green:255  blue:255 alpha:1]
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, self.frame.size.height - 1, kPICKVIEW_SCREEN_WIDTH, 1)];
        lineView.backgroundColor = [UIColor colorWithHex:0xd1d3d5];
...
- (UIButton *)leftButton
{
    if (!_leftButton) {
        ...
        _leftButton.titleLabel.font = PickFont(18);
//        [_leftButton setTitleColor:PickFontColor(blackColor) forState:UIControlStateNormal];
        [_leftButton setTitleColor:[UIColor colorWithHex:0x249dee] forState:UIControlStateNormal];
...
- (UIButton *)rightButton
{
    if (!_rightButton) {
        ...
        _rightButton.titleLabel.font = PickFont(18);
//        [_rightButton setTitleColor:PickFontColor(blackColor) forState:UIControlStateNormal];
        [_rightButton setTitleColor:[UIColor colorWithHex:0x249dee] forState:UIControlStateNormal];
