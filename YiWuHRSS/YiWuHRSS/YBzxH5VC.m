...
// UIWebViewDelegate,TSWebViewDelegate,JS_ZXViewController,

@interface YBzxH5VC ()<WKNavigationDelegate,WKUIDelegate,WKScriptMessageHandler>
...
- (void)setUpH5{
    ...
    NSString *url = [NSString stringWithFormat:@"%@payOpen.html?access_token=%@&device_type=2&openStatus=1",H5_HOST,[CoreArchive strForKey:LOGIN_ACCESS_TOKEN]];
    DMLog(@"url=%@",url);
